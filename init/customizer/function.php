...
function topline_custom_dashboard() {
	echo '<p>Welcome To eKapi News - By TopLine Technology Pvt.Ltd. ! You Can Change The Site Logo With The <a href="'.site_url('/wp-admin/customize.php').'">Theme Option</a> And Go To The <b>Site Identity</b>,  You Can Customize Theme With The <a href="'.site_url('/wp-admin/customize.php').'">Theme Customize</a> And You Can Place The Advertisement With The <a href="'.site_url('/wp-admin/widgets.php').'">Theme Wedgets</a>. Need Help? Contact The Developer <a href="mailto:support@toplinetech.com.np">Here</a>. </p>';
}
