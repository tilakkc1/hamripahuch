				...
				<div class="col-md-12 col-sm-12 col-12">
					<div class="row bg-white m-0 p-3 mb-3">
						...
						<div class="col-md-3 col-4 text-center">
							<img class="img-fluid author_image" src="<?php echo $attachment_id; ?>">
						</div>
						<div class="col-md-9 col-8">
							...
							<div class="social__data_icon d-block">
								<ul class="list-unstyled mt-3">
									<li style="background: #3b5998"><a href="<?php echo $facebook_url; ?>"
											target="_blank"><i class="fa fa-facebook ml-1"></i></a></li>
									<li class="ml-2" style="background: #00acee"><a href="<?php echo $twitter_url; ?>"
