	...
	<div class="container">
		...
		if($banner_loop -> have_posts()):
			while($banner_loop -> have_posts()): 
				...
				?>
				<div class="baanner_item w-100 bg-white mt-3 p-3">
						...
						<div class="banner text-center">
							<?php if(get_field('feature_title')): ?>
								<div class="feature_title mt-4 text-light" style="border-bottom: 1px var(--tlt-secondary) solid">
									<span style="font-size: 18px; background: var(--tlt-secondary); padding: 3px 20px 0px 20px;"><?php echo get_field('feature_title') ?></span>
								</div>
							<?php endif; ?>
							<h1 class="p-3">
