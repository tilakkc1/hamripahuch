<div class="radio-container mt-4">
    <div class="radio-container-block p-4" style="background: linear-gradient(135deg, #0345a9, #e74c3c);">
        <div class="row">
            <div class="col-md-8">
                    ...
                    if (!empty($video_id)): ?>
                        <div class="video_container">
                            <iframe
                                ...
                                width="100%" height="380" style="border:none;overflow:hidden" scrolling="no" frameborder="0"
            ...
            <div class="col-md-4">
                <?php echo get_template_part('home-parts/taja-samachar'); ?>
            </div>
        </div>
    </div>
</div>